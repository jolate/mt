...
In this section we will explain the memory model of modern computers and its relevance in algorithms performance and parallelism.

\subsection{Modern computers memory hierarchy}
...
\subsection{Cache and parallelism}
