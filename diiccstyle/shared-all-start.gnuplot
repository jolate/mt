...
set xtics nomirror
set ytics nomirror
plot "shared-all-start.dat" using 1:2 ls 1 ps 0.5 title '{/Times=6  goldb-heqc-alu4mul}' with linespoints, \
"shared-all-start.dat" using 1:3 ls 2 ps 0.5 title '{/Times=6  goldb-heqc-i8mul}' with linespoints, \
"shared-all-start.dat" using 1:4 ls 3 ps 0.5 title '{/Times=6  ibm-2002-31_1r3-k30}' with linespoints, \
"shared-all-start.dat" using 1:5 ls 4 ps 0.5 title '{/Times=6  ibm-2004-23-k80}' with linespoints, \
"shared-all-start.dat" using 1:6 ls 5 ps 0.5 title '{/Times=6 manol-pipe-g10bid_i}' with linespoints, \
"shared-all-start.dat" using 1:7 ls 6 ps 0.5 title '{/Times=6 post-c32s-gcdm16-22}' with linespoints, \
"shared-all-start.dat" using 1:8 ls 7 ps 0.5 title '{/Times=6 schup-l2s-motst-2-k315}' with linespoints, \
"shared-all-start.dat" using 1:9 ls 8 ps 0.5 title '{/Times=6 simon-s02-f2clk-50}' with linespoints