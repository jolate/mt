...
################################################################################
#
# FILE NAME: AzuDICIPerfDecaySharedAll
#
# PURPOSE:
#
...
set output "AzuDICIPerfDecaySharedAll.eps"
set border
...
set xtics nomirror
set ytics nomirror
plot "AzuDICITimeSharedAll.dat" using 1:2 lt 2 lw 0.5 ps 0.5 title '{/Times=6 goldb-heqc-i8mul}' with linespoints, \
